...
const OFFRE_FAQ = [
  ...
  { question: "Comment contacter le support ?", answer: "Via le chat en ligne (disponible 24h/24), par email à contact@nelloabank.com, ou par téléphone du lundi au samedi de 8h à 20h." },
];
